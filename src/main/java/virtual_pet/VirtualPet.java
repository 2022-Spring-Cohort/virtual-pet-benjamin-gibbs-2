...
//    private String name;
//    private int age;
//    // all int below will be on a 0 to 20 scale. 0 being 'empty' and 20 being 'full'
//    // hunger of 0 is STARVING - hunger of 20 is FULL
...
//int upperbound = 200;
//int randHunger = rand.nextInt(upperbound);
//    int randThirst = rand.nextInt(upperbound);
//        //CONSTRUCTOR  //
//
//    public VirtualPet(String name, int age, String pronouns) {
//        this.name = name;
//        this.age = age;
//        this.hunger = randHunger;
//        this.thirst = randThirst;
//        this.boredom = 5;
//        this.waste = 5;
//        this.sickness = 5;
//        this.cuddles = 5;
